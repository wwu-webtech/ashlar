...
$advanced_h2.replaceWith('<button aria-label="open advanced search" class="toggle-advanced-search">Advanced search<i class="material-icons" aria-hidden="true">add</i></button>');
