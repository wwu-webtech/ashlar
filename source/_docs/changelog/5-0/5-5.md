...
* Fix for CKEDitor font color
* Icon fixed for x.com URLs
* Function call error fixed
* Support for Entity Print module added (in progress)

## 5.5.12
** August 18, 2025 **
* Webform accessibility fixes (2d scrolling, dark mode)
* Focus fix for navigation
* Style fixes for accordion expand/collapse
