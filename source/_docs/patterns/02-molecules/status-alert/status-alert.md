...
<div class="status-alert">
    <p class="material-icons status-color" aria-hidden="true">
        tag_faces
    </p>
...
## Active - Minor
<div className="status-alert sstatus-alert--minor">
    <p className="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
...
```
<div class="status-alert status-alert--minor">
    <p class="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
    <p class="status status-color">Status: active</p>
    ...
    <div class="body">
        ...
        <p class="severity status-color">Severity: minor</p>
    </div>
</div>
```

## Active - Major
<div className="status-alert status-alert--active status-alert--major">
    <p className="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
    <p className="status status-color">Status: active</p>
...
```
<div class="status-alert status-alert--active status-alert--major">
    <p class="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
    <p class="status status-color">Status: active</p>
    ...
    <div class="body">
        ...
        <p class="severity status-color">Severity: major</p>
    </div>
</div>
```

## Active - Critical
<div className="status-alert status-alert--critical">
    <p className="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
    <p className="status status-color">Status: active</p>
...
```
<div class="status-alert status-alert--critical">
    <p class="material-icons status-color" aria-hidden="true">
        error_outline
    </p>
    <p class="status status-color">Status: active</p>
    ...
    <div class="body">
        ...
        *****Original Message***** <p><strong>11/22/19, 1:30 PM:</strong> Self-Service Password Reset, the
        ...
        <p class="severity status-color">Severity: critical</p>
    </div>
</div>
```

## Resolved
<div className="status-alert status-alert--resolved">   
    <p className="material-icons status-color" aria-hidden="true">
...
```
<div class="status-alert status-alert--resolved">   
    <p class="material-icons status-color" aria-hidden="true">
        check_circle_outline
    </p>
    <p class="status status-color">Status: resolved</p>
